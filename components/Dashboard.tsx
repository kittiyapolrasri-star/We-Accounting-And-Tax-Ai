  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      <div className="flex justify-between items-end">
        <div>
           <h1 className="text-3xl font-bold text-slate-900 tracking-tight">ภาพรวมสำนักงาน (Operation Center)</h1>
           <p className="text-slate-500 mt-1">Live Monitoring & Performance Tracking</p>
        </div>
