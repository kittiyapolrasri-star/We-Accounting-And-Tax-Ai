       ...
       <div className="flex justify-between items-center mb-6">
        ...
        {selectedDocs.size > 0 && (
            <div className="flex gap-2 animate-in slide-in-from-right fade-in">
                <button className="px-4 py-2 bg-white border border-slate-200 text-slate-600 font-medium rounded-lg text-sm hover:bg-slate-50 transition-colors flex items-center gap-2 shadow-sm">
                                    ...
                                    <td className="px-6 py-3">
                                         {item.type === 'folder' ? (
                                             ...
                                             <span className={`text-[10px] uppercase font-bold px-2 py-1 rounded-full ${
                                                item.data.status === 'approved' ? 'bg-emerald-50 text-emerald-600' :
