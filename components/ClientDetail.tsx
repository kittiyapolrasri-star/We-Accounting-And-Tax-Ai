       ...
       <div className="flex-1 overflow-y-auto p-8 bg-slate-50">
                           ...
                           <div className="grid grid-cols-3 gap-4">
                               <div className="bg-slate-50 p-4 rounded-xl text-center border border-slate-100">
                                   ...
                                   <div className={`text-sm font-bold px-3 py-1.5 rounded-lg inline-block ${
                                       client.current_workflow.vat_status === 'Filed/Closed' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'
                                   }`}>
                               ...
                               <div className="bg-slate-50 p-4 rounded-xl text-center border border-slate-100">
                                   ...
                                   <div className={`text-sm font-bold px-3 py-1.5 rounded-lg inline-block ${
                                       client.current_workflow.wht_status === 'Filed/Closed' ? 'bg-emerald-100 text-emerald-700' : 'bg-blue-100 text-blue-700'
                                   }`}>
                               ...
                               <div className="bg-slate-50 p-4 rounded-xl text-center border border-slate-100">
                                   ...
                                   <div className={`text-sm font-bold px-3 py-1.5 rounded-lg inline-block ${
                                       client.current_workflow.closing_status === 'Filed/Closed' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-600'
                                   }`}>
           ...
           {activeTab === 'audit' && (
               <AuditClosing 
                    ...
                    isLocked={client.current_workflow.is_locked}
                    onPostJournal={handleLocalPost}
                />
           )}
